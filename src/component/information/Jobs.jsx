...
const Jobs = () => {
  return (
    <div className="jobs-container pt-28 bg-gradient-to-r from-blue-900 to-purple-900 p-10 rounded-2xl shadow-lg max-w-4xl mx-auto mt-10 mb-10 relative z-10">
