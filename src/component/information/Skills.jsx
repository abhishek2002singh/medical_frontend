...
const Skills = () => {
  return (
    <div
      className="skills-container pt-20 relative mx-auto p-10 rounded-2xl shadow-lg max-w-5xl hover:shadow-2xl transform hover:scale-105 transition-all duration-500 ease-in-out bg-fixed bg-cover bg-center"
      style={{
          ...
          <div className="skill-category bg-gradient-to-br from-blue-700 to-green-500 p-8 rounded-xl shadow-lg hover:shadow-2xl transform hover:scale-105 transition-all duration-500 ease-in-out">
            ...
            <div className="space-y-3 text-lg">
              ...
              <p>
                ...
                GitHub, GitHub Desktop, Postman, Debugger ,AWS 
              </p>
              <p>
